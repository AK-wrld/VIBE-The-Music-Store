...
if(play===false) {
  ...
  useEffect(GetASong,[play,array])
    ...
    return (
        <QueueContext.Provider value={{queue,showQueue,btnStyle,switchBtn,queueshift,changeQueueShift,array,setArray,empty,isEmpty,play,isPlaying,counter,setCounter,btnref,trref}}>
